...
import { ValStatusV1StatusDto } from './val-status-v1-status-dto';

/**
 * 
 * @export
 * @interface ValStatusV1PlatformDataDto
 */
export interface ValStatusV1PlatformDataDto {
    /**
     * 
     * @type {string}
     * @memberof ValStatusV1PlatformDataDto
     */
    id: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<ValStatusV1StatusDto>}
     * @memberof ValStatusV1PlatformDataDto
     */
    maintenances: Array<ValStatusV1StatusDto>;
    /**
     * 
     * @type {Array<ValStatusV1StatusDto>}
     * @memberof ValStatusV1PlatformDataDto
     */
    incidents: Array<ValStatusV1StatusDto>;
}
