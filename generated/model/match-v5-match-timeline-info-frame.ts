...
import { MatchV5MatchTimelineInfoFrameEvent } from './match-v5-match-timeline-info-frame-event';
import { MatchV5MatchTimelineInfoFrameParticipantFrames } from './match-v5-match-timeline-info-frame-participant-frames';

/**
 * 
 * @export
 * @interface MatchV5MatchTimelineInfoFrame
 */
export interface MatchV5MatchTimelineInfoFrame {
    /**
     * 
     * @type {Array<MatchV5MatchTimelineInfoFrameEvent>}
     * @memberof MatchV5MatchTimelineInfoFrame
     */
    events: Array<MatchV5MatchTimelineInfoFrameEvent>;
    /**
     * 
     * @type {MatchV5MatchTimelineInfoFrameParticipantFrames}
     * @memberof MatchV5MatchTimelineInfoFrame
     */
