...
import { LolStatusV4StatusDto } from './lol-status-v4-status-dto';

/**
 * 
 * @export
 * @interface LolStatusV4PlatformDataDto
 */
export interface LolStatusV4PlatformDataDto {
    /**
     * 
     * @type {string}
     * @memberof LolStatusV4PlatformDataDto
     */
    id: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<LolStatusV4StatusDto>}
     * @memberof LolStatusV4PlatformDataDto
     */
    maintenances: Array<LolStatusV4StatusDto>;
    /**
     * 
     * @type {Array<LolStatusV4StatusDto>}
     * @memberof LolStatusV4PlatformDataDto
     */
    incidents: Array<LolStatusV4StatusDto>;
}
