...
import { ValContentV1LocalizedNamesDto } from './val-content-v1-localized-names-dto';

/**
 * 
 * @export
 * @interface ValContentV1ContentItemDto
 */
export interface ValContentV1ContentItemDto {
    /**
     * 
     * @type {string}
     * @memberof ValContentV1ContentItemDto
     */
    name: string;
    /**
     * 
     * @type {ValContentV1LocalizedNamesDto}
     * @memberof ValContentV1ContentItemDto
     */
