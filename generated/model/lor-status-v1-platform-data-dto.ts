...
import { LorStatusV1StatusDto } from './lor-status-v1-status-dto';

/**
 * 
 * @export
 * @interface LorStatusV1PlatformDataDto
 */
export interface LorStatusV1PlatformDataDto {
    /**
     * 
     * @type {string}
     * @memberof LorStatusV1PlatformDataDto
     */
    id: string;
    /**
     * 
    ...
    /**
     * 
     * @type {Array<LorStatusV1StatusDto>}
     * @memberof LorStatusV1PlatformDataDto
     */
    maintenances: Array<LorStatusV1StatusDto>;
    /**
     * 
     * @type {Array<LorStatusV1StatusDto>}
     * @memberof LorStatusV1PlatformDataDto
     */
    incidents: Array<LorStatusV1StatusDto>;
}
