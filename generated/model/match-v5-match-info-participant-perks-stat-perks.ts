 ...
 * 
 * @export
 * @interface MatchV5MatchInfoParticipantPerksStatPerks
 */
export interface MatchV5MatchInfoParticipantPerksStatPerks {
    /**
     * 
     * @type {number}
     * @memberof MatchV5MatchInfoParticipantPerksStatPerks
     */
    defense: number;
    /**
     * 
