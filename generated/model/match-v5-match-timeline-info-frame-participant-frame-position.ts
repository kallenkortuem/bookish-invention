 ...
 * 
 * @export
 * @interface MatchV5MatchTimelineInfoFrameParticipantFramePosition
 */
export interface MatchV5MatchTimelineInfoFrameParticipantFramePosition {
    /**
     * 
     * @type {number}
     * @memberof MatchV5MatchTimelineInfoFrameParticipantFramePosition
     */
    x: number;
    /**
     * 
