...
import { MatchV5MatchInfoParticipantPerksStatPerks } from './match-v5-match-info-participant-perks-stat-perks';
import { MatchV5MatchInfoParticipantPerksStyle } from './match-v5-match-info-participant-perks-style';

/**
 * 
 * @export
 * @interface MatchV5MatchInfoParticipantPerks
 */
export interface MatchV5MatchInfoParticipantPerks {
    /**
     * 
     * @type {MatchV5MatchInfoParticipantPerksStatPerks}
     * @memberof MatchV5MatchInfoParticipantPerks
     */
    statPerks: MatchV5MatchInfoParticipantPerksStatPerks;
    /**
     * 
     * @type {Array<MatchV5MatchInfoParticipantPerksStyle>}
     * @memberof MatchV5MatchInfoParticipantPerks
     */
    styles: Array<MatchV5MatchInfoParticipantPerksStyle>;
}
