...
import { MatchV5MatchMetadata } from './match-v5-match-metadata';
import { MatchV5MatchTimelineInfo } from './match-v5-match-timeline-info';

/**
 * 
 * @export
 * @interface MatchV5MatchTimeline
 */
export interface MatchV5MatchTimeline {
    /**
     * 
     * @type {MatchV5MatchMetadata}
     * @memberof MatchV5MatchTimeline
     */
    metadata: MatchV5MatchMetadata;
    /**
     * 
     * @type {MatchV5MatchTimelineInfo}
     * @memberof MatchV5MatchTimeline
     */
