...
import { ClashV1PlayerDto } from './clash-v1-player-dto';

/**
 * 
 * @export
 * @interface ClashV1TeamDto
 */
export interface ClashV1TeamDto {
    /**
     * 
     * @type {string}
     * @memberof ClashV1TeamDto
     */
    id: string;
    /**
     * 
    ...
    /**
     * Team members.
     * @type {Array<ClashV1PlayerDto>}
     * @memberof ClashV1TeamDto
     */
    players: Array<ClashV1PlayerDto>;
}
