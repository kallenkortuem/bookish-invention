...
import { MatchV5MatchInfoParticipantPerksStyleSelection } from './match-v5-match-info-participant-perks-style-selection';

/**
 * 
 * @export
 * @interface MatchV5MatchInfoParticipantPerksStyle
 */
export interface MatchV5MatchInfoParticipantPerksStyle {
    /**
     * 
     * @type {string}
     * @memberof MatchV5MatchInfoParticipantPerksStyle
     */
    description: string;
    /**
     * 
     * @type {Array<MatchV5MatchInfoParticipantPerksStyleSelection>}
     * @memberof MatchV5MatchInfoParticipantPerksStyle
     */
    selections: Array<MatchV5MatchInfoParticipantPerksStyleSelection>;
    /**
     * 
     * @type {number}
     * @memberof MatchV5MatchInfoParticipantPerksStyle
