...
import { ValMatchV1MatchlistEntryDto } from './val-match-v1-matchlist-entry-dto';

/**
 * 
 * @export
 * @interface ValMatchV1MatchlistDto
 */
export interface ValMatchV1MatchlistDto {
    /**
     * 
     * @type {string}
     * @memberof ValMatchV1MatchlistDto
     */
    puuid: string;
    /**
     * 
     * @type {Array<ValMatchV1MatchlistEntryDto>}
     * @memberof ValMatchV1MatchlistDto
     */
    history: Array<ValMatchV1MatchlistEntryDto>;
}
