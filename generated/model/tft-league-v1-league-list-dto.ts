...
import { TftLeagueV1LeagueItemDTO } from './tft-league-v1-league-item-dto';

/**
 * 
 * @export
 * @interface TftLeagueV1LeagueListDTO
 */
export interface TftLeagueV1LeagueListDTO {
    /**
     * 
     * @type {string}
     * @memberof TftLeagueV1LeagueListDTO
     */
    leagueId: string;
    /**
     * 
     * @type {Array<TftLeagueV1LeagueItemDTO>}
     * @memberof TftLeagueV1LeagueListDTO
     */
    entries: Array<TftLeagueV1LeagueItemDTO>;
    /**
     * 
     * @type {string}
     * @memberof TftLeagueV1LeagueListDTO
