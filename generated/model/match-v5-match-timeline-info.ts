...
import { MatchV5MatchTimelineInfoFrame } from './match-v5-match-timeline-info-frame';
import { MatchV5MatchTimelineInfoParticipant } from './match-v5-match-timeline-info-participant';

/**
 * 
 * @export
 * @interface MatchV5MatchTimelineInfo
 */
export interface MatchV5MatchTimelineInfo {
    /**
     * 
     * @type {number}
     * @memberof MatchV5MatchTimelineInfo
     */
    frameInterval: number;
    /**
     * 
     * @type {Array<MatchV5MatchTimelineInfoFrame>}
     * @memberof MatchV5MatchTimelineInfo
     */
    frames: Array<MatchV5MatchTimelineInfoFrame>;
    /**
     * 
     * @type {number}
     * @memberof MatchV5MatchTimelineInfo
    ...
    /**
     * 
     * @type {Array<MatchV5MatchTimelineInfoParticipant>}
     * @memberof MatchV5MatchTimelineInfo
     */
    participants: Array<MatchV5MatchTimelineInfoParticipant>;
}
