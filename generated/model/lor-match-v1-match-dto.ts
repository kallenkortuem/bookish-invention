...
import { LorMatchV1InfoDto } from './lor-match-v1-info-dto';
import { LorMatchV1MetadataDto } from './lor-match-v1-metadata-dto';

/**
 * 
 * @export
 * @interface LorMatchV1MatchDto
 */
export interface LorMatchV1MatchDto {
    /**
     * 
     * @type {LorMatchV1MetadataDto}
     * @memberof LorMatchV1MatchDto
     */
    metadata: LorMatchV1MetadataDto;
    /**
     * 
     * @type {LorMatchV1InfoDto}
     * @memberof LorMatchV1MatchDto
     */
