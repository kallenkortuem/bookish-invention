...
import { MatchV5MatchInfoTeamObjective } from './match-v5-match-info-team-objective';

/**
 * 
 * @export
 * @interface MatchV5MatchInfoTeamObjectives
 */
export interface MatchV5MatchInfoTeamObjectives {
    /**
     * 
     * @type {MatchV5MatchInfoTeamObjective}
     * @memberof MatchV5MatchInfoTeamObjectives
     */
    baron: MatchV5MatchInfoTeamObjective;
    /**
     * 
     * @type {MatchV5MatchInfoTeamObjective}
     * @memberof MatchV5MatchInfoTeamObjectives
     */
    champion: MatchV5MatchInfoTeamObjective;
    /**
     * 
     * @type {MatchV5MatchInfoTeamObjective}
     * @memberof MatchV5MatchInfoTeamObjectives
     */
    dragon: MatchV5MatchInfoTeamObjective;
    /**
     * 
     * @type {MatchV5MatchInfoTeamObjective}
     * @memberof MatchV5MatchInfoTeamObjectives
     */
    inhibitor: MatchV5MatchInfoTeamObjective;
    /**
     * 
     * @type {MatchV5MatchInfoTeamObjective}
     * @memberof MatchV5MatchInfoTeamObjectives
     */
    riftHerald: MatchV5MatchInfoTeamObjective;
    /**
     * 
     * @type {MatchV5MatchInfoTeamObjective}
     * @memberof MatchV5MatchInfoTeamObjectives
     */
    tower: MatchV5MatchInfoTeamObjective;
}
