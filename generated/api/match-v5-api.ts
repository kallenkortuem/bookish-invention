...
export const MatchV5ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async matchV5GetMatch(matchId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
         ...
         * @throws {RequiredError}
         */
        async matchV5GetTimeline(matchId: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<object>> {
...
export const MatchV5ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        matchV5GetMatch(matchId: string, options?: any): AxiosPromise<object> {
         ...
         * @throws {RequiredError}
         */
        matchV5GetTimeline(matchId: string, options?: any): AxiosPromise<object> {
